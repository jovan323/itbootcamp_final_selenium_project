...
//        loginPage.getLoginButton().click();
        ...
        Assert.assertTrue(citiesPage.getInputCityBox().getAttribute("type").contains("text"),
                "Incorrect input type for edit/create");
    }
...
//        loginPage.getLoginButton().click();
        ...
        Thread.sleep(2000);
        Assert.assertTrue
                (citiesPage.getTableBodyCell(1, 2).getText().contains("Bangkok"),
...
//        loginPage.getLoginButton().click();
        ...
        messagePopUpPage.waitForPopUp();
        Assert.assertTrue
                (driver.findElement(By.xpath("//div[contains(@class, 'success')]")).getText().contains("Deleted successfully"),
                "Dialog doesn't display the correct message");
    }
